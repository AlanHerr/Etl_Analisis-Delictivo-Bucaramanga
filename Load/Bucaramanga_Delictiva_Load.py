...
import sqlite3  # Libreria para manejo de bases de datos SQLite

class BucaramangaDelictivaLoader:
    """
    ...
    def to_sqlite(self, db_path="Extract/files/Informacion_Delictiva_Bucaramanga.db", table_name="delitos_bucaramanga"):
        """
        Guarda el DataFrame limpio en una base de datos SQLite.
        Args:
            db_path (str): Ruta de la base de datos SQLite.
            table_name (str): Nombre de la tabla donde se guardaran los datos.
        """
        try:
